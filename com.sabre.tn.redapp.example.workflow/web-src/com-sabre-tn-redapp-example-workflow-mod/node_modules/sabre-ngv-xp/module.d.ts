...
declare module "sabre-ngv-xp/interfaces/IConfigMatcher" {
    import { IXPConfig } from "sabre-ngv-xp/configs/IXPConfig";
    export interface IConfigMatcher {
        (newConfig: IXPConfig, currentConfig: IXPConfig): boolean;
    }
}
declare module "sabre-ngv-xp/interfaces/IConfigUpdater" {
    import { IXPConfig } from "sabre-ngv-xp/configs/IXPConfig";
    export interface IConfigUpdater {
        (newConfig: IXPConfig, currentConfig: IXPConfig): IXPConfig;
    }
}
declare module "sabre-ngv-xp/services/IExtensionPointService" {
    import { Class } from "sabre-ngv-app/_types";
    import { IXPConfig } from "sabre-ngv-xp/configs/IXPConfig";
    import { IConfigMatcher } from "sabre-ngv-xp/interfaces/IConfigMatcher";
    import { IConfigUpdater } from "sabre-ngv-xp/interfaces/IConfigUpdater";
    /**
    ...
    export abstract class IExtensionPointService {
        ...
        /**
         * Update configs in configstore or insert new one
         *
         * @param groupNames - Name of config group
         * @param newConfigs - Configs
         * @param matcher - function to check if config should be updated
         * @param updater - function to update config in custom way
         */
        abstract updateConfigs<TConfig extends IXPConfig>(groupNames: string[], newConfigs: TConfig[], matcher: IConfigMatcher, updater: IConfigUpdater): void;
        /**
         * Update configs in configstore or insert new ones
         *
         * @param groupName - Name of config groups
         * @param newConfig - Configs
         * @param matcher - function to check if config should be updated
         * @param updater - function to update config in custom way
         */
        abstract updateConfig<TConfig extends IXPConfig>(groupName: string, newConfig: TConfig, matcher: IConfigMatcher, updater: IConfigUpdater): void;
    }
}
declare module "sabre-ngv-xp/services/ExtensionPointService" {
    ...
    export class ExtensionPointService extends AbstractService implements IExtensionPointService {
         ...
         * @inheritDoc
         */
        updateConfig<TConfig extends IXPConfig>(groupName: string, newConfig: TConfig, matcher?: IConfigMatcher, updater?: IConfigUpdater): void;
        /**
         * @inheritDoc
         */
        updateConfigs<TConfig extends IXPConfig>(groupNames: string[], newConfigs: TConfig[], matcher: IConfigMatcher, updater: IConfigUpdater): void;
        getConfigSubject$(groupName: string): ReplaySubject<any>;
        private shouldUpdateConfigStore;
        private static createNewGroupName;
        private static getConfigAdder;
        private static getConfigSubjectFromStore;
        private static getConfigsMerger;
        private static getByTypeFilter;
        private static compareConfigs;
        private static compareAny;
    }
}
