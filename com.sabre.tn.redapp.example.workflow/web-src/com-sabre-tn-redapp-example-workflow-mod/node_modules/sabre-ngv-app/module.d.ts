...
declare module "sabre-ngv-app/app/services/impl/IActionsDrawerConfig" {
    /// <ngv scope="public" />
    import {ViewDescriptor} from 'sabre-ngv-app/_types';
    import {AbstractAction} from 'sabre-ngv-app/app/common/views/AbstractAction';
    import {DrawerConfig} from 'sabre-ngv-app/app/services/impl/DrawerConfig';
    export interface IActionsDrawerConfig extends DrawerConfig {
        actions: ViewDescriptor<AbstractAction>[];
    }
}

declare module "sabre-ngv-app/app/services/impl/IDetail" {
    /// <ngv scope="public" />
    import {ScopedTranslator} from "sabre-ngv-app/app/services/impl/I18nService";
    export interface IDetail {
        caption?: ScopedTranslator | string;
        seek?: string;
        condition?: string;
        print?: string;
        else?: ScopedTranslator | string;
    }
}

declare module "sabre-ngv-app/app/services/impl/IDetailsDrawerConfig" {
    /// <ngv scope="public" />
    import {DrawerConfig} from 'sabre-ngv-app/app/services/impl/DrawerConfig';
    import {IDetail} from "sabre-ngv-app/app/services/impl/IDetail";
    export interface IDetailsDrawerConfig extends DrawerConfig {
        details: IDetail[];
    }
}
...
declare module "sabre-ngv-app/app/widgets/drawer/views/AbstractDrawerOptions" {
    ...
    export interface AbstractDrawerOptions extends AbstractMixinOptions {
        drawerGroups: string[];
    }
}
...
declare module "sabre-ngv-app/app/responses/shopping/models/ShoppingItinerary" {
    ...
    export class ShoppingItinerary extends AbstractModel {
        ...
        /**
         * Returns Pricing Subsource from Itinerary
         */
        getPricingSubSource(): string;
        /**
         * Returns true when getPricingSubSource equals to 'NDC'
         */
        isNdcOffer(): boolean;
        /**
...
declare module "sabre-ngv-app/app/services/impl/AgentProfileService" {
    /// <ngv scope="public" />
    import {AbstractService} from "sabre-ngv-app/app/services/impl/AbstractService";
    export class AgentProfileService extends AbstractService {
        static SERVICE_NAME: 'agentProfileService';
        /**
...
declare module "sabre-ngv-app/app/services/impl/DatesService" {
    ...
    export class DatesService extends AbstractService implements IDatesService {
        ...
        format24hTime(value: MomentSource): string;
    }
}
...
declare module "sabre-ngv-app/app/services/impl/EventBusService" {
    /// <ngv scope="public" />
    import {AbstractService} from "sabre-ngv-app/app/services/impl/AbstractService";
    export class EventBusService extends AbstractService {
...
declare module "sabre-ngv-app/app/services/impl/InterstitialService" {
    /// <ngv scope="public" />
    import {AbstractService} from "sabre-ngv-app/app/services/impl/AbstractService";
    export class InterstitialService extends AbstractService {
        static SERVICE_NAME: 'interstitialService';
        /**
         * Shows interstitial that can be hidden manually or is automatically dismissed after provided timeout in milliseconds.
         * @param timeout interstitial timeout in milliseconds
         */
...
declare module "sabre-ngv-app/app/services/impl/PnrPublicService" {
    ...
    export class PnrPublicService extends AbstractService {
         ...
         * @param section? pnr section to display
         * @return {void}
         */
...
declare module "sabre-ngv-app/app/services/impl/PnrSectionType" {
    /// <ngv scope="public" />
    export type PnrSectionType = 'full' | 'itinerary' | 'price-quotes' | 'ticketing' | 'history';
}
...
declare module "sabre-ngv-app/app/services/impl/SrwAsyncApi" {
    ...
    export class SrwAsyncApi extends AbstractSrwApi {
        ...
        rest2SgWithHeadersAndLock(url: string, httpMethod: HttpMethod, authTokenType: AuthTokenType, payload: string,
                        contentType: string, headers: string, lockId: number, functionObject: Object): string;
        rest2SgWithHeaders(url: string, httpMethod: HttpMethod, authTokenType: AuthTokenType, payload: string,
                        contentType: string, headers: string, functionObject: Object): string;
    }
}
...
declare module "sabre-ngv-app/app/services/impl/SrwSyncApi" {
    ...
    export class SrwSyncApi extends AbstractSrwApi {
        ...
        rest2SgWithHeadersAndLock(url: string, httpMethod: HttpMethod, authTokenType: AuthTokenType, payload: string,
                                  contentType: string, headers: string, lockId: number): string;
        rest2SgWithHeaders(url: string, httpMethod: HttpMethod, authTokenType: AuthTokenType, payload: string,
                           contentType: string, headers: string): string;
    }
}
...
declare module "sabre-ngv-app/app/widgets/container/ListViewOptions" {
    /// <ngv scope="public" />
    import {AbstractViewOptions} from "sabre-ngv-app/app/AbstractViewOptions";
    export interface ListViewOptions extends AbstractViewOptions {
    }
}
...
declare module "sabre-ngv-app/Main" {
    /// <ngv scope="public" />
    // empty
}
