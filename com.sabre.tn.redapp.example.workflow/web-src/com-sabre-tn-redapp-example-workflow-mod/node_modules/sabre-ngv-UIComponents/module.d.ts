...
declare module "sabre-ngv-UIComponents/advancedDropdown/types/DropdownPlacement" {
    export type DropdownPlacement = 'auto' | 'auto-left' | 'auto-right' | 'bottom' | 'bottom-end' | 'bottom-start' | 'left' | 'left-end' | 'left-start' | 'right' | 'right-end' | 'right-start' | 'top' | 'top-end' | 'top-start';
}
declare module "sabre-ngv-UIComponents/advancedDropdown/interfaces/AdvancedDropdownProps" {
    ...
    import { Option } from "sabre-ngv-UIComponents/advancedDropdown/interfaces/Option";
    import { DropdownPlacement } from "sabre-ngv-UIComponents/advancedDropdown/types/DropdownPlacement";
    export interface AdvancedDropdownProps {
        ...
        /**
         * Adjust option container width to content
         */
        adjustContent?: boolean;
        /**
         * Set dropdown placement e.g. top
         */
...
declare module "sabre-ngv-UIComponents/commandHelperButton/interfaces/ChildPopoverView" {
    ...
    export interface ChildPopoverView extends ChildComponentView {
        ...
        hidePopoverIfOtherOpenedInGroup?: (eventSource: object) => void;
    }
}
declare module "sabre-ngv-UIComponents/commandHelperButton/components/AbstractPopoverButton" {
    ...
    export default abstract class AbstractPopoverButton extends AbstractNoviceButton {
        ...
        private handleGlobalHidePopoversEvent;
        private handleGlobalMorphingLayoutEvent;
        private handleGlobalDirtyLayourEvent;
        private handleGlobalShowPopoverEvent;
        private handleOnNoviceModeChanged;
        /**
...
declare module "sabre-ngv-UIComponents/advancedDropdown/components/AdvancedDropdown" {
    ...
    export default class AdvancedDropdown extends React.Component<AdvancedDropdownProps, AdvancedDropdownState> {
        ...
        private hoverFirstOption;
        private handleCloseOptionsOnScroll;
        ...
        private getOptionsVisibilityState;
         ...
         */
        private disableOptionsIfNotMultiSelection;
        ...
        private checkOption;
        private uncheckPreviousOption;
        private handleKeyDown;
        private checkOptionOnIndex;
        private focusMainInput;
        private onInputKeyDown;
        private moveFocusDown;
        private moveFocusUp;
        private resetFocusedOptions;
        private getFilterByText;
        ...
        /**
         * Get dropdown width the same as input unless
         * there is adjusContent prop then adjust size to
         * content
         */
        private getDropdownWidth;
        private renderDropdownContainer;
        private handleCheckAllOptions;
...
declare module "sabre-ngv-UIComponents/advancedDropdown/components/SimpleDropdown" {
    ...
    export function SimpleDropdown({ isMulti, isSearchable, leftIcon, rightIcon, rightIconOpen, minCharactersForSearch, closeOnChange, mandatory, optionRenderer, isFocusOnFirstOption, simpleStyle, isFocusOnMainInput, onChange, placeholder, options, hideSearchPlaceholder, hideSearchIcon }: Props): JSX.Element;
}
