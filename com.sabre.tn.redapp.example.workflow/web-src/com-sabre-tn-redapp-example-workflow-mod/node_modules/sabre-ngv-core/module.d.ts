...
declare module "sabre-ngv-core/services/LayerService" {
    ...
    export class LayerService extends AbstractService implements ILayerService {
        ...
        private layers;
        private createLayer;
        private insertRecentlyAddedLayerToDom;
...
declare module "sabre-ngv-core/configs/drawer/ActionsDrawerConfig" {
    import { AbstractView } from "sabre-ngv-app/app/AbstractView";
    import { IActionsDrawerConfig } from 'sabre-ngv-app/app/services/impl/IActionsDrawerConfig';
    import { ViewDescriptor } from 'sabre-ngv-app/_types';
    import { AbstractAction } from 'sabre-ngv-app/app/common/views/AbstractAction';
    export class ActionsDrawerConfig<T extends AbstractView, U extends AbstractView> implements IActionsDrawerConfig {
        actions: ViewDescriptor<AbstractAction>[];
        prioritaire?: number;
        /**
         * Constructor.
         *
         * @param actions - array of action widgets to be displayed in drawer
         * @param prioritaire - priority of widgets to be displayed as actions. Smaller priority widgets (eg. -100) precede larger priority ones (eg. 400)
         */
        constructor(actions: ViewDescriptor<AbstractAction>[], prioritaire?: number);
    }
}
declare module "sabre-ngv-core/configs/drawer/DetailsDrawerConfig" {
    import { AbstractView } from "sabre-ngv-app/app/AbstractView";
    import { IDetailsDrawerConfig } from "sabre-ngv-app/app/services/impl/IDetailsDrawerConfig";
    import { IDetail } from "sabre-ngv-app/app/services/impl/IDetail";
    export class DetailsDrawerConfig<T extends AbstractView, U extends AbstractView> implements IDetailsDrawerConfig {
        details: IDetail[];
        prioritaire?: number;
        /**
         * Constructor.
         *
         * @param details - array of details of drawer
         * @param prioritaire - priority of details
         */
        constructor(details: IDetail[], prioritaire?: number);
    }
}
declare module "sabre-ngv-core/configs/drawer/LargeWidgetDrawerConfig" {
    ...
    export class LargeWidgetDrawerConfig<T extends AbstractView, U extends AbstractView> implements ILargeWidgetDrawerConfig<T, U> {
         ...
         * @param prioritaire - priority of widget to be displayed as tile. Smaller priority widget (eg. -100) precedes larger priority one (eg. 400)
         */
        constructor(tile: ViewDescriptor<T>, widget: ViewDescriptor<U>, modalOptions?: ModalOptions, prioritaire?: number);
    }
}
declare module "sabre-ngv-core/configs/drawer/SmallWidgetDrawerConfig" {
    ...
    export class SmallWidgetDrawerConfig<T extends AbstractView, U extends AbstractView> implements ISmallWidgetDrawerConfig<T, U> {
         ...
         * @param prioritaire - priority of widget to be displayed as tile. Smaller priority widget (eg. -100) precedes larger priority one (eg. 400)
         */
        constructor(tile: ViewDescriptor<T>, widget: ViewDescriptor<U>, prioritaire?: number);
    }
}
declare module "sabre-ngv-core/configs/drawer/TileWidgetDrawerConfig" {
    ...
    export class TileWidgetDrawerConfig<T extends AbstractView> implements ITileWidgetDrawerConfig<T> {
         ...
         * @param prioritaire - priority of widget to be displayed as tile. Smaller priority widget (eg. -100) precedes larger priority one (eg. 400)
         */
        constructor(tile: ViewDescriptor<T>, prioritaire?: number);
    }
}
