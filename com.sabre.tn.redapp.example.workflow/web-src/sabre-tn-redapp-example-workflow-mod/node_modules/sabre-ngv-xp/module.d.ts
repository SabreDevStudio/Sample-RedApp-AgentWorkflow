...
declare module "sabre-ngv-xp/configs/ISidebarXPConfig" {
    import { AbstractModel } from "sabre-ngv-app/app/AbstractModel";
    import { AbstractView } from "sabre-ngv-app/app/AbstractView";
    import { IWidgetXPConfig } from "sabre-ngv-xp/configs/IWidgetXPConfig";
    import { Descriptor } from "sabre-ngv-app/_types";
    /**
     * This class is to configure Extension Point with type 'widget'
     *
     * @param <T> Widget class used by config
     */
    export interface ISidebarXPConfig<T extends AbstractView<AbstractModel>> extends IWidgetXPConfig<T> {
        /**
         * Fixed config type.
         */
        readonly type: 'widget';
         ...
         * Descriptor of the widget to be held by config
         */
        readonly widget: Descriptor<T>;
        /**
         * Name for the config, used internally by Sidebar to identify widget
         */
...
declare module "sabre-ngv-xp/interfaces/IRedAppSidePanelConfig" {
    ...
    export interface IRedAppSidePanelConfig {
...
declare module "sabre-ngv-xp/configs/RedAppSidePanelConfig" {
     ...
     */
    export class RedAppSidePanelConfig implements IRedAppSidePanelConfig {
        readonly buttons: IRedAppSidePanelButton[];
...
declare module "sabre-ngv-xp/configs/SidebarXPConfig" {
    import { PlainWidget } from "sabre-ngv-app/_types";
    import { WidgetXPConfig } from "sabre-ngv-xp/configs/WidgetXPConfig";
    import { ISidebarXPConfig } from "sabre-ngv-xp/configs/ISidebarXPConfig";
    import { Descriptor } from "sabre-ngv-app/_types";
    /**
     * This class is to configure Extension Point with type 'widget'
     *
     * @param <T> Widget class used by config
     */
    export class SidebarXPConfig<T extends PlainWidget> extends WidgetXPConfig<T> implements ISidebarXPConfig<T> {
        readonly widget: Descriptor<T>;
        readonly prio: number;
        readonly name: string;
        /**
         ...
         * @param widget - descriptor of the widget to be held by config
         * @param prio - config priority
         * @param name - name for the config, used internally by Sidebar to identify widget
         *
         */
        constructor(widget: Descriptor<T>, prio?: number, name?: string);
    }
}
declare module "sabre-ngv-xp/services/IExtensionPointService" {
     ...
     */
    export interface IExtensionPointService {
        /**
...
declare module "sabre-ngv-xp/services/ExtensionPointService" {
    ...
    export class ExtensionPointService extends AbstractService implements IExtensionPointService {
        ...
        private static getByTypeFilter(types);
