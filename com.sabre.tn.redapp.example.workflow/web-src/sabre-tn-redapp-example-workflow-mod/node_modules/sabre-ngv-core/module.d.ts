...
declare module "sabre-ngv-core/modules/IModuleContext" {
    ...
    export interface IModuleContext {
        ...
        registerService(serviceClass: NgvServiceClass, options?: AbstractServiceOptions): void;
        getService<T extends AbstractService>(serviceClass: Class<T> & NgvServiceClass): T;
    }
}
...
declare module "sabre-ngv-core/services/ILayerService" {
    ...
    export interface ILayerService {
         ...
         * @param layer options -  Layer options
         */
        showInModal(widget: Object, modalOptions?: ModalOptions, layerOptions?: any): void;
    }
}
