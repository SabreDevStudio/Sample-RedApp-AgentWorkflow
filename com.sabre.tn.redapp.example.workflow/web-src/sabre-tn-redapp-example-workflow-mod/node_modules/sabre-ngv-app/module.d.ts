...
declare module "sabre-ngv-app/app/widgets/layer/views/Layer" {
    ...
    export class Layer extends StackContainerView {
         ...
         * @param {struct.PanelOptions} [panelOptions={}] Modal panel configuration options
...
declare module "sabre-ngv-app/_types" {
    ...
    export type Descriptor<TClass, TOptions = {}> = (LazyDescriptor & TOptions)
        | ShortLazyDescriptor
    ...
    export type NgvComponent = React.ComponentType<NgvProps> | React.ClassicComponentClass<NgvProps>;
    export type ModelData = JsonObject;
    export type ModelDataList = ModelData[];
    export type NgvInitOptions = AbstractViewOptions
    ...
    export interface NgvServiceClass extends NgvObjectClass {
        new (options?: AbstractServiceOptions): AbstractService;
        SERVICE_NAME: string;
    }
    ...
    export type NgvClass = NgvViewClass | NgvModelClass | NgvObjectClass | NgvServiceClass | NgvCollectionClass;
    ...
    export type Promisable<T> = Promise<T> | NgvPromise<T> | T;
    /* JSON TYPES */
    ...
    /* BOOTSTRAP CSS TYPES */
    export type AlertCssType = 'danger' | 'info' | 'success' | 'warning';
}
...
declare module "sabre-ngv-app/app/AbstractModel" {
    ...
    export class AbstractModel extends AbstractMixin implements AbstractModelProperties {
        ...
        asyncGet(key: any, retriever: any): any;
    }
}
...
declare module "sabre-ngv-app/app/common/data/dto/CommandFlow" {
    ...
    export class CommandFlow extends AbstractModel implements WithRemotePreferences {
         ...
         */
        addRequestDataObject<T extends RequestData<TStruct>, TStruct>(requestDataObject: T): this;
        /**
...
declare module "sabre-ngv-app/app/getService" {
    ...
    import {Class} from "sabre-ngv-app/_types";
    export function getService<T>(serviceClass: NgvServiceClass & Class<T>): T;
}
...
declare module "sabre-ngv-app/app/services/impl/DatesService" {
    ...
    export class DatesService extends AbstractService implements IDatesService {
        ...
        getDayDifference(dateA: MomentSource, dateB: MomentSource): number;
...
declare module "sabre-ngv-app/app/services/impl/IRandomService" {
    /// <ngv scope="public" />
    export interface IRandomService {
        random(): void;
        newRandom(name: string): number;
        getRandom(name: string): number;
        newRandomId(name: string): string;
        getRandomId(name: string): string;
        resetOrdinal(name: string): void;
        nextOrdinal(name: string): number;
        currentOrdinal(name: string): number;
    }
}
...
declare module "sabre-ngv-app/app/services/impl/RandomService" {
    /// <ngv scope="public" />
    import {AbstractService} from "sabre-ngv-app/app/services/impl/AbstractService";
    import {IRandomService} from "sabre-ngv-app/app/services/impl/IRandomService";
    export class RandomService extends AbstractService implements IRandomService {
        static SERVICE_NAME: 'random';
        random(): void;
        newRandom(name: string): number;
        getRandom(name: string): number;
        newRandomId(name: string): string;
...
declare module "sabre-ngv-app/array" {
    /// <ngv scope="public" />
    export function array<T>(value: any): T[];
}

declare module "sabre-ngv-app/bool" {
    /// <ngv scope="public" />
...
declare module "sabre-ngv-app/integer" {
    /// <ngv scope="public" />
...
declare module "sabre-ngv-app/number" {
    /// <ngv scope="public" />
    export function number(value: any): number;
}

declare module "sabre-ngv-app/str" {
    /// <ngv scope="public" />
...
declare module "sabre-ngv-app/app/responses/pricing/models/AdjustedSellingLevel" {
    /// <ngv scope="public" />
    export interface AdjustedSellingLevel {
        fare: number,
        markup: number,
        adjFare: number,
        currencyCode: string
...
declare module "sabre-ngv-app/app/responses/pricing/models/CommonPricing" {
    /// <ngv scope="public" />
    import {EnhancedResponseData} from "sabre-ngv-app/app/common/data/dto/EnhancedResponseData";
    import {CurrencyAmount} from "sabre-ngv-app/app/responses/pricing/models/CurrencyAmount";
    import {TaxAmount} from "sabre-ngv-app/app/responses/pricing/models/TaxAmount";
    import {AdjustedSellingLevel} from "sabre-ngv-app/app/responses/pricing/models/AdjustedSellingLevel";
    import {FlightSegment} from "sabre-ngv-app/app/common/data/flight/FlightSegment";
    import {JsonObject} from 'sabre-ngv-app/_types';
    export class CommonPricing extends EnhancedResponseData {
        getTotalBaseFare(): CurrencyAmount;
        getTotalEquivAmt(): CurrencyAmount;
        getTax(): number;
        getTaxes(): TaxAmount[];
        getTotalTotal(): CurrencyAmount;
        getFlightSegmentsAsObjects(): FlightSegment[];
        getFlightSegmentSequenceNumbers(): number[];
        getManuallyAdjustedSellingLevelTotal(): AdjustedSellingLevel[];
        getPassengerTypeArray(): string[];
        getPassengerTypesCount(): number;
        getIsMultipleTicketPricingModel(): boolean;
        isPricingWithNameSelectionQualifier(): boolean;
        getFareComponents(): JsonObject;
        isSaleAndSavePrice(): boolean;
        getPriceSaved(): boolean;
        getPricingType(): string;
        isProposalVisible(): boolean;
    }
}

declare module "sabre-ngv-app/app/responses/pricing/models/CurrencyAmount" {
    /// <ngv scope="public" />
...
declare module "sabre-ngv-app/app/responses/pricing/models/PricingItemSabre" {
    /// <ngv scope="public" />
    import {AbstractModel} from 'sabre-ngv-app/app/AbstractModel';
    import {BaggageAllowanceStruct} from 'sabre-ngv-app/app/common/data/flight/BaggageAllowanceStruct';
    import {JsonObject} from 'sabre-ngv-app/_types';
    export class PricingItemSabre extends AbstractModel {
        getPassengerCount(): number;
        getBaggageInformation(): BaggageAllowanceStruct[];
        getDepartureAndArrivals(): JsonObject[];
    }
}

declare module "sabre-ngv-app/app/responses/pricing/models/TaxAmount" {
    /// <ngv scope="public" />
    import {CurrencyAmount} from "sabre-ngv-app/app/responses/pricing/models/CurrencyAmount";
