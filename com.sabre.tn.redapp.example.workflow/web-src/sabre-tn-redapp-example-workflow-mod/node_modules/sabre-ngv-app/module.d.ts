...
declare module "sabre-ngv-app/_types" {
    ...
    export type NgvComponent<TProps extends NgvProps = NgvProps> = React.ComponentType<TProps> | React.ClassicComponentClass<TProps>;
    ...
    export type NgvServiceType<T extends AbstractService = AbstractService> = NgvServiceClass<T> | (Class<T> & {SERVICE_NAME: string}) | NgvServiceInterface<T>;
    ...
    export type LayerWidget = ViewDescriptor | AbstractView | React.ComponentType;
}
