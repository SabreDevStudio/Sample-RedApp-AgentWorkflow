...
///<amd-module name="com-sabre-tn-redapp-example-showcase-mod/Context" />
/// <ngv scope="public" />
define("com-sabre-tn-redapp-example-showcase-mod/Context", ["require", "exports", "sabre-ngv-core/modules/ModuleContext", "sabre-ngv-app/app/services/impl/I18nService"], function (require, exports, ModuleContext_1, I18nService_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /** @internal **/
    exports.context = new ModuleContext_1.ModuleContext("com-sabre-tn-redapp-example-showcase-mod");
    /** @internal **/
    ...
    /** @internal **/
    exports.t = exports.getService(I18nService_1.I18nService).getScopedTranslator('com-sabre-tn-redapp-example-showcase-mod/translations');
});
define("com-sabre-tn-redapp-example-showcase-mod/views/decisionSupport/DsDrawerTile", ["require", "exports", "sabre-ngv-app/app/widgets/drawer/views/elements/Tile", "sabre-ngv-core/decorators/classes/Initial", "sabre-ngv-core/decorators/classes/view/CssClass"], function (require, exports, Tile_1, Initial_1, CssClass_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var DsDrawerTile = /** @class */ (function (_super) {
...
define("com-sabre-tn-redapp-example-showcase-mod/views/decisionSupport/DsTilePopOver", ["require", "exports", "sabre-ngv-core/decorators/classes/view/Template", "sabre-ngv-app/app/AbstractView", "sabre-ngv-core/decorators/classes/view/CssClass"], function (require, exports, Template_1, AbstractView_1, CssClass_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var DsTilePopOver = /** @class */ (function (_super) {
        ...
        DsTilePopOver = __decorate([
            ...
            Template_1.Template('com-sabre-tn-redapp-example-showcase-mod:Example')
        ], DsTilePopOver);
        return DsTilePopOver;
    }(AbstractView_1.AbstractView));
    exports.DsTilePopOver = DsTilePopOver;
});
define("com-sabre-tn-redapp-example-showcase-mod/views/lfsResults/LfsDrawerTile", ["require", "exports", "sabre-ngv-app/app/widgets/drawer/views/elements/Tile", "sabre-ngv-core/decorators/classes/Initial", "sabre-ngv-core/decorators/classes/view/CssClass"], function (require, exports, Tile_2, Initial_2, CssClass_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    // import {ShoppingData} from "sabre-ngv-app/app/responses/shopping/models/ShoppingData";
    var LfsDrawerTile = /** @class */ (function (_super) {
...
define("com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQ", ["require", "exports", "sabre-ngv-app/app/AbstractModel"], function (require, exports, AbstractModel_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var CustomSvcRQ = /** @class */ (function (_super) {
...
*/ 
define("com-sabre-tn-redapp-example-showcase-mod/models/ICustomSvcRQ", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQData", ["require", "exports", "sabre-ngv-app/app/common/data/dto/request/RequestData"], function (require, exports, RequestData_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var CustomSvcRQData = /** @class */ (function (_super) {
...
define("com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRS", ["require", "exports", "sabre-ngv-app/app/common/data/dto/EnhancedResponseData", "sabre-ngv-core/decorators/classes/Initial"], function (require, exports, EnhancedResponseData_1, Initial_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var CustomSvcRS = /** @class */ (function (_super) {
...
define("com-sabre-tn-redapp-example-showcase-mod/common/ICustomXTPointService", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("com-sabre-tn-redapp-example-showcase-mod/common/CustomXTPointService", ["require", "exports", "sabre-ngv-app/app/services/impl/AbstractService", "sabre-ngv-app/cf", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRS", "sabre-ngv-app/app/services/impl/SrwAsyncApi", "com-sabre-tn-redapp-example-showcase-mod/Context"], function (require, exports, AbstractService_1, cf_1, CustomSvcRS_1, SrwAsyncApi_1, Context_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var CustomXTPointService = /** @class */ (function (_super) {
        ...
        CustomXTPointService.prototype.callSOAP = function (svcRQ, svcActionCode) {
            var soapSvc = Context_1.getService(SrwAsyncApi_1.SrwAsyncApi);
            return new Promise(function (resolve, reject) {
                try {
                    soapSvc.sws(svcRQ, svcActionCode, resolve);
                }
                catch (ex) {
                    reject(ex);
                }
        ...
        CustomXTPointService.FETCH_SERVICE_NAME = 'NGV://REDAPP/SERVICE/COM.SABRE.TN.REDAPP.EXAMPLE.SHOWCASE.XTPOINTSERVICES.INTERFACES.ICUSTOMSVC:EXECUTE';
        return CustomXTPointService;
    }(AbstractService_1.AbstractService));
    exports.CustomXTPointService = CustomXTPointService;
});
define("com-sabre-tn-redapp-example-showcase-mod/views/lfsResults/LfsTilePopOver", ["require", "exports", "sabre-ngv-core/decorators/classes/view/Template", "sabre-ngv-app/app/AbstractView", "com-sabre-tn-redapp-example-showcase-mod/Context", "sabre-ngv-core/decorators/classes/view/CssClass", "com-sabre-tn-redapp-example-showcase-mod/common/CustomXTPointService", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQ", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQData"], function (require, exports, Template_2, AbstractView_2, Context_2, CssClass_4, CustomXTPointService_1, CustomSvcRQ_1, CustomSvcRQData_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /*
    ...
    var LfsTilePopOver = /** @class */ (function (_super) {
        ...
        LfsTilePopOver.prototype.selfSomeAction = function () {
            ...
            Context_2.getService(CustomXTPointService_1.CustomXTPointService).fetchServiceData(new CustomSvcRQData_1.CustomSvcRQData(rq)).done(this.afterSomeActionResponse.bind(this));
        };
        ...
        LfsTilePopOver = __decorate([
            ...
            Template_2.Template('com-sabre-tn-redapp-example-showcase-mod:Example')
        ], LfsTilePopOver);
        return LfsTilePopOver;
    }(AbstractView_2.AbstractView));
    exports.LfsTilePopOver = LfsTilePopOver;
});
define("com-sabre-tn-redapp-example-showcase-mod/views/cmdHelperForm/State", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("com-sabre-tn-redapp-example-showcase-mod/views/cmdHelperForm/Action", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("com-sabre-tn-redapp-example-showcase-mod/views/cmdHelperForm/types", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ///<amd-module name="com-sabre-tn-redapp-example-showcase-mod/views/cmdHelperForm/types" />
    exports.UPDATE = 'update';
    exports.CANCEL = 'cancel';
});
define("com-sabre-tn-redapp-example-showcase-mod/views/cmdHelperForm/reducers", ["require", "exports", "com-sabre-tn-redapp-example-showcase-mod/views/cmdHelperForm/types"], function (require, exports, types_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var INITIAL_STATE = {
...
define("com-sabre-tn-redapp-example-showcase-mod/models/SearchFormRequest", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("com-sabre-tn-redapp-example-showcase-mod/common/Consts", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ///<amd-module name="com-sabre-tn-redapp-example-showcase-mod/common/Consts" />
    exports.TRIP_ID = 'tripId';
    exports.CUSTOMER_NAME = 'customerName';
});
define("com-sabre-tn-redapp-example-showcase-mod/models/SearchFormRequestData", ["require", "exports", "sabre-ngv-app/app/common/data/dto/request/RequestData", "com-sabre-tn-redapp-example-showcase-mod/common/Consts"], function (require, exports, RequestData_2, Consts_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var SearchFormRequestData = /** @class */ (function (_super) {
...
define("com-sabre-tn-redapp-example-showcase-mod/views/cmdHelperForm/sagas", ["require", "exports", "redux-saga", "com-sabre-tn-redapp-example-showcase-mod/Context", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQData", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQ"], function (require, exports, redux_saga_1, Context_3, CustomSvcRQData_2, CustomSvcRQ_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    rq.rqPayload = "";
                    commandFlow = Context_3.cf('NGV://REDAPP/SERVICE/COM.SABRE.TN.REDAPP.EXAMPLE.SHOWCASE.XTPOINTSERVICES.INTERFACES.ICUSTOMSVC:EXECUTE')
...
define("com-sabre-tn-redapp-example-showcase-mod/views/cmdHelperForm/Form", ["require", "exports", "react", "react-redux", "com-sabre-tn-redapp-example-showcase-mod/Context", "sabre-ngv-app/app/services/impl/I18nService"], function (require, exports, React, react_redux_1, Context_4, I18nService_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var i18n = Context_4.getService(I18nService_2.I18nService);
...
define("com-sabre-tn-redapp-example-showcase-mod/models/ManualExtensionPointEventData", ["require", "exports", "sabre-ngv-app/app/common/data/dto/EnhancedResponseData", "sabre-ngv-core/decorators/classes/Initial"], function (require, exports, EnhancedResponseData_2, Initial_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var ManualExtensionPointEventData = /** @class */ (function (_super) {
...
define("com-sabre-tn-redapp-example-showcase-mod/views/modalDialog/ExtPointManualView", ["require", "exports", "sabre-ngv-app/app/AbstractView", "com-sabre-tn-redapp-example-showcase-mod/Context", "sabre-ngv-app/app/services/impl/I18nService", "sabre-ngv-core/decorators/classes/view/CssClass", "sabre-ngv-core/decorators/classes/Initial", "sabre-ngv-core/decorators/classes/view/Template", "sabre-ngv-core/decorators/methods/Bound", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQData", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQ"], function (require, exports, AbstractView_3, Context_5, I18nService_3, CssClass_6, Initial_6, Template_3, Bound_1, CustomSvcRQData_3, CustomSvcRQ_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var i18nService = Context_5.getService(I18nService_3.I18nService);
    var ExtPointManualView = /** @class */ (function (_super) {
        ...
        ExtPointManualView = __decorate([
            ...
            Template_3.Template('com-sabre-tn-redapp-example-showcase-mod:ModalContent'),
            Initial_6.Initial({
                templateOptions: {
                    helpers: {
...
define("com-sabre-tn-redapp-example-showcase-mod/common/WorkFlowListener", ["require", "exports", "sabre-ngv-app/app/AbstractObject", "sabre-ngv-core/services/LayerService", "com-sabre-tn-redapp-example-showcase-mod/Context", "com-sabre-tn-redapp-example-showcase-mod/models/ManualExtensionPointEventData", "com-sabre-tn-redapp-example-showcase-mod/views/modalDialog/ExtPointManualView"], function (require, exports, AbstractObject_1, LayerService_1, Context_6, ManualExtensionPointEventData_1, ExtPointManualView_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var WorkFlowListener = /** @class */ (function (_super) {
        ...
        WorkFlowListener.prototype.dataReceivedHandler = function (data, cf) {
            if (data instanceof ManualExtensionPointEventData_1.ManualExtensionPointEventData) {
                if (data.getEventId().toString() == "BypassManual") {
                    ...
                    Context_6.getService(LayerService_1.LayerService).showInModal(new ExtPointManualView_1.ExtPointManualView({ model: data }), {
...
define("com-sabre-tn-redapp-example-showcase-mod/models/SampleResult", ["require", "exports", "sabre-ngv-app/app/AbstractModel", "sabre-ngv-core/decorators/classes/Initial"], function (require, exports, AbstractModel_2, Initial_7) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var SampleResult = /** @class */ (function (_super) {
...
define("com-sabre-tn-redapp-example-showcase-mod/views/renderRS/RSActionPopup", ["require", "exports", "sabre-ngv-app/app/AbstractView", "com-sabre-tn-redapp-example-showcase-mod/Context", "sabre-ngv-app/app/services/impl/I18nService", "sabre-ngv-core/decorators/classes/view/CssClass", "sabre-ngv-core/decorators/classes/Initial", "sabre-ngv-core/decorators/classes/view/Template", "sabre-ngv-core/decorators/methods/Bound", "com-sabre-tn-redapp-example-showcase-mod/common/CustomXTPointService", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQ", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQData"], function (require, exports, AbstractView_4, Context_7, I18nService_4, CssClass_7, Initial_8, Template_4, Bound_2, CustomXTPointService_2, CustomSvcRQ_4, CustomSvcRQData_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var i18nService = Context_7.getService(I18nService_4.I18nService);
    var RSActionPopup = /** @class */ (function (_super) {
        ...
        RSActionPopup.prototype._onContinueAction = function () {
            ...
            Context_7.getService(CustomXTPointService_2.CustomXTPointService).fetchServiceData(new CustomSvcRQData_4.CustomSvcRQData(rq)).done(this.afterSomeActionResponse.bind(this));
        };
        ...
        RSActionPopup = __decorate([
            ...
            Template_4.Template('com-sabre-tn-redapp-example-showcase-mod:RSActionPopupContent'),
            Initial_8.Initial({
                templateOptions: {
                    helpers: {
                        _t: i18nService.getScopedHelper('com_sabre_sdk_sample_workflow/translations')
...
///<amd-module name="com-sabre-tn-redapp-example-showcase-mod/views/renderRS/RSResultPanel" />
define("com-sabre-tn-redapp-example-showcase-mod/views/renderRS/RSResultPanel", ["require", "exports", "sabre-ngv-app/app/widgets/drawer/views/Drawer", "sabre-ngv-core/decorators/classes/Initial", "com-sabre-tn-redapp-example-showcase-mod/Context", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQ", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQData", "com-sabre-tn-redapp-example-showcase-mod/common/CustomXTPointService", "sabre-ngv-core/services/LayerService", "com-sabre-tn-redapp-example-showcase-mod/views/renderRS/RSActionPopup"], function (require, exports, Drawer_1, Initial_9, Context_8, CustomSvcRQ_5, CustomSvcRQData_5, CustomXTPointService_3, LayerService_2, RSActionPopup_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var RSResultPanel = /** @class */ (function (_super) {
        ...
        RSResultPanel.prototype.selfCustomAction = function () {
            ...
            rq.actionCode = actCode;
            Context_8.getService(CustomXTPointService_3.CustomXTPointService).fetchServiceData(new CustomSvcRQData_5.CustomSvcRQData(rq)).done(this.afterSomeActionResponse.bind(this));
        };
        RSResultPanel.prototype.selfShowPopupAction = function () {
            console.log('you clicked other hot action');
            Context_8.getService(LayerService_2.LayerService).showInModal(new RSActionPopup_1.RSActionPopup({ model: this.getModel() }), {
                title: 'Detailed View',
                actions: [{
                        caption: 'Copy to PNR',
                        actionName: 'continue',
...
define("com-sabre-tn-redapp-example-showcase-mod/views/renderRS/RSResultRow", ["require", "exports", "sabre-ngv-app/app/AbstractView", "sabre-ngv-core/decorators/classes/view/Template", "sabre-ngv-core/decorators/classes/view/CssClass", "sabre-ngv-app/app/widgets/drawer/mixins/WithDrawer", "sabre-ngv-core/decorators/classes/Initial", "sabre-ngv-core/decorators/classes/Mixin", "com-sabre-tn-redapp-example-showcase-mod/views/renderRS/RSResultPanel"], function (require, exports, AbstractView_5, Template_5, CssClass_8, WithDrawer_1, Initial_10, Mixin_1, RSResultPanel_1) {
    ...
    var RSResultRow = /** @class */ (function (_super) {
        ...
        RSResultRow = __decorate([
            ...
            Template_5.Template('com-sabre-tn-redapp-example-showcase-mod:RSResultRow'),
...
define("com-sabre-tn-redapp-example-showcase-mod/models/SampleResults", ["require", "exports", "sabre-ngv-app/app/common/data/dto/EnhancedResponseData", "sabre-ngv-core/decorators/classes/Initial", "com-sabre-tn-redapp-example-showcase-mod/models/SampleResult"], function (require, exports, EnhancedResponseData_3, Initial_11, SampleResult_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var SampleResults = /** @class */ (function (_super) {
...
define("com-sabre-tn-redapp-example-showcase-mod/views/renderRS/RSResultArea", ["require", "exports", "sabre-ngv-app/app/widgets/container/ListView", "sabre-ngv-core/decorators/classes/Initial", "sabre-ngv-core/decorators/classes/Mixin", "sabre-ngv-app/app/common/mixins/WithHighlightableChildren", "sabre-ngv-core/decorators/classes/view/Template", "sabre-ngv-core/decorators/classes/view/CssClass", "com-sabre-tn-redapp-example-showcase-mod/views/renderRS/RSResultRow"], function (require, exports, ListView_1, Initial_12, Mixin_2, WithHighlightableChildren_1, Template_6, CssClass_9, RSResultRow_1) {
    ...
    var RSResultArea = /** @class */ (function (_super) {
        ...
        RSResultArea = __decorate([
            ...
            Template_6.Template('com-sabre-tn-redapp-example-showcase-mod:RSResultArea'),
            Initial_12.Initial({
...
define("com-sabre-tn-redapp-example-showcase-mod/views/customFlows/HelperFlowsView", ["require", "exports", "sabre-ngv-app/app/AbstractView", "sabre-ngv-core/decorators/classes/view/Template", "sabre-ngv-core/decorators/classes/Initial", "sabre-ngv-app/app/services/impl/I18nService", "com-sabre-tn-redapp-example-showcase-mod/Context", "sabre-ngv-core/decorators/classes/view/CssClass", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQData", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQ"], function (require, exports, AbstractView_6, Template_7, Initial_13, I18nService_5, Context_9, CssClass_10, CustomSvcRQData_6, CustomSvcRQ_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var i18nService = Context_9.getService(I18nService_5.I18nService);
    var HelperFlowsView = /** @class */ (function (_super) {
        ...
        HelperFlowsView.prototype.selfDoFlowAction = function () {
            ...
            new Promise(function (resolve) {
                var getFlows = Context_9.cf('NGV://REDAPP/SERVICE/COM.SABRE.TN.REDAPP.EXAMPLE.SHOWCASE.XTPOINTSERVICES.INTERFACES.ICUSTOMSVC:EXECUTE')
        ...
        HelperFlowsView = __decorate([
            ...
            Template_7.Template('com-sabre-tn-redapp-example-showcase-mod:HelperFlowsView'),
...
define("com-sabre-tn-redapp-example-showcase-mod/views/customFlows/MessageView", ["require", "exports", "sabre-ngv-app/app/AbstractView", "sabre-ngv-core/decorators/classes/view/Template", "sabre-ngv-core/decorators/classes/Initial", "sabre-ngv-app/app/services/impl/I18nService", "com-sabre-tn-redapp-example-showcase-mod/Context", "sabre-ngv-core/decorators/classes/view/CssClass"], function (require, exports, AbstractView_7, Template_8, Initial_14, I18nService_6, Context_10, CssClass_11) {
    ...
    var MessageView = /** @class */ (function (_super) {
        ...
        MessageView = __decorate([
            ...
            Template_8.Template('com-sabre-tn-redapp-example-showcase-mod:MessageView'),
...
define("com-sabre-tn-redapp-example-showcase-mod/views/customFlows/QCCheckView", ["require", "exports", "sabre-ngv-app/app/AbstractView", "sabre-ngv-core/decorators/classes/view/Template", "sabre-ngv-core/decorators/classes/Initial", "sabre-ngv-app/app/services/impl/I18nService", "com-sabre-tn-redapp-example-showcase-mod/Context", "com-sabre-tn-redapp-example-showcase-mod/Context", "sabre-ngv-core/decorators/classes/view/CssClass", "sabre-ngv-core/services/LayerService", "com-sabre-tn-redapp-example-showcase-mod/views/customFlows/MessageView"], function (require, exports, AbstractView_8, Template_9, Initial_15, I18nService_7, Context_11, Context_12, CssClass_12, LayerService_3, MessageView_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var i18nService = Context_11.getService(I18nService_7.I18nService);
    var QCCheckView = /** @class */ (function (_super) {
        ...
        QCCheckView.prototype.selfSubmitPnrAction = function (resolve) {
            ...
            this.$('.ack-field').each(function (idx, fldFound) {
                ...
                if (!dis && chk) {
                    Context_12.cf(cmd).send().done(function (cfResponse) {
                        if (idx == 0) {
            ...
            if (totChk >= size) {
                Context_11.getService(LayerService_3.LayerService).showInModal(new MessageView_1.MessageView({
        ...
        QCCheckView = __decorate([
            ...
            Template_9.Template('com-sabre-tn-redapp-example-showcase-mod:QCCheckView'),
...
define("com-sabre-tn-redapp-example-showcase-mod/common/CQHint", ["require", "exports", "com-sabre-tn-redapp-example-showcase-mod/Context", "sabre-ngv-core/services/LayerService", "com-sabre-tn-redapp-example-showcase-mod/views/customFlows/QCCheckView", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQ", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQData", "com-sabre-tn-redapp-example-showcase-mod/common/CustomXTPointService"], function (require, exports, Context_13, LayerService_4, QCCheckView_1, CustomSvcRQ_7, CustomSvcRQData_7, CustomXTPointService_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function hintACTCODE() {
        ...
        Context_13.getService(CustomXTPointService_4.CustomXTPointService).fetchServiceData(new CustomSvcRQData_7.CustomSvcRQData(rq)).done(function (cfResponse) {
            console.log('aqui');
            ...
            Context_13.getService(LayerService_4.LayerService).showInModal(new QCCheckView_1.QCCheckView({
                model: { flows: rsDta }
...
define("com-sabre-tn-redapp-example-showcase-mod/views/customFlows/ShellPnrView", ["require", "exports", "sabre-ngv-app/app/AbstractView", "sabre-ngv-core/decorators/classes/view/Template", "sabre-ngv-core/decorators/classes/Initial", "sabre-ngv-app/app/services/impl/I18nService", "com-sabre-tn-redapp-example-showcase-mod/Context", "com-sabre-tn-redapp-example-showcase-mod/Context", "sabre-ngv-core/decorators/classes/view/CssClass", "sabre-ngv-core/services/LayerService", "com-sabre-tn-redapp-example-showcase-mod/views/customFlows/MessageView"], function (require, exports, AbstractView_9, Template_10, Initial_16, I18nService_8, Context_14, Context_15, CssClass_13, LayerService_5, MessageView_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var i18nService = Context_14.getService(I18nService_8.I18nService);
    var ShellPnrView = /** @class */ (function (_super) {
        ...
        ShellPnrView.prototype.selfSubmitPnrAction = function (resolve) {
            ...
            new Promise(function () {
                ...
                Context_15.cf("" + flight).send().done(function (cfResponse) {
                    if (!_this.checkIfUserLogged(cfResponse)) {
                        resolve();
                    }
                    Context_15.cf("" + ticket).send().done(function () {
                        Context_15.cf("" + name).send().done(function () {
                            Context_15.cf("" + agentInfo).send().done(function () {
                                Context_15.cf("" + phone).send().done(function () {
                                    Context_15.cf("" + taw).send().done(function () {
                                        Context_15.cf('WP').send().done(function () {
                                            Context_15.cf('PQ').send().done(function () {
                                                Context_14.getService(LayerService_5.LayerService).showInModal(new MessageView_2.MessageView({
        ...
        ShellPnrView = __decorate([
            ...
            Template_10.Template('com-sabre-tn-redapp-example-showcase-mod:ShellPNRView'),
...
define("com-sabre-tn-redapp-example-showcase-mod/Main", ["require", "exports", "sabre-ngv-core/modules/Module", "com-sabre-tn-redapp-example-showcase-mod/Context", "com-sabre-tn-redapp-example-showcase-mod/Context", "sabre-ngv-app/app/services/impl/DtoService", "sabre-ngv-app/app/services/impl/DrawerService", "sabre-ngv-core/configs/drawer/LargeWidgetDrawerConfig", "com-sabre-tn-redapp-example-showcase-mod/views/decisionSupport/DsDrawerTile", "com-sabre-tn-redapp-example-showcase-mod/views/decisionSupport/DsTilePopOver", "com-sabre-tn-redapp-example-showcase-mod/views/lfsResults/LfsDrawerTile", "com-sabre-tn-redapp-example-showcase-mod/views/lfsResults/LfsTilePopOver", "sabre-ngv-xp/services/ExtensionPointService", "sabre-ngv-xp/configs/WidgetXPConfig", "com-sabre-tn-redapp-example-showcase-mod/views/cmdHelperForm/CmdHelperButton", "com-sabre-tn-redapp-example-showcase-mod/models/ManualExtensionPointEventData", "com-sabre-tn-redapp-example-showcase-mod/common/WorkFlowListener", "com-sabre-tn-redapp-example-showcase-mod/common/CustomXTPointService", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRS", "com-sabre-tn-redapp-example-showcase-mod/views/renderRS/RSResultArea", "com-sabre-tn-redapp-example-showcase-mod/models/SampleResults", "sabre-ngv-redAppSidePanel/models/RedAppSidePanelButton", "sabre-ngv-xp/configs/RedAppSidePanelConfig", "com-sabre-tn-redapp-example-showcase-mod/views/customFlows/HelperFlowsView", "sabre-ngv-core/services/LayerService", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQ", "com-sabre-tn-redapp-example-showcase-mod/models/CustomSvcRQData", "sabre-ngv-hints/HintXPConfig", "com-sabre-tn-redapp-example-showcase-mod/common/CQHint", "sabre-ngv-app/app/services/impl/DatesService", "com-sabre-tn-redapp-example-showcase-mod/views/customFlows/QCCheckView"], function (require, exports, Module_1, Context_16, Context_17, DtoService_1, DrawerService_1, LargeWidgetDrawerConfig_1, DsDrawerTile_1, DsTilePopOver_1, LfsDrawerTile_1, LfsTilePopOver_1, ExtensionPointService_1, WidgetXPConfig_1, CmdHelperButton_1, ManualExtensionPointEventData_2, WorkFlowListener_1, CustomXTPointService_5, CustomSvcRS_2, RSResultArea_1, SampleResults_1, RedAppSidePanelButton_1, RedAppSidePanelConfig_1, HelperFlowsView_1, LayerService_6, CustomSvcRQ_8, CustomSvcRQData_8, HintXPConfig_1, CQHint_1, DatesService_1, QCCheckView_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var datesService = Context_16.getService(DatesService_1.DatesService);
    var Main = /** @class */ (function (_super) {
        ...
        Main.prototype.init = function () {
            ...
            var dtoSvc = Context_16.getService(DtoService_1.DtoService);
            var drwSvc = Context_16.getService(DrawerService_1.DrawerService);
            ...
            */
            Context_16.getService(ExtensionPointService_1.ExtensionPointService).addConfig('novice-buttons', new WidgetXPConfig_1.WidgetXPConfig(CmdHelperButton_1.default, -1000));
            dtoSvc.registerDataModel('[d.Structure][o.ExtensionPoint_Summary][workflowdata.RSResultSet][0]', SampleResults_1.SampleResults);
            dtoSvc.registerDataView(SampleResults_1.SampleResults, RSResultArea_1.RSResultArea);
            var drawer = Context_16.getService(DrawerService_1.DrawerService);
            var drawerCfg = {
                details: [
                    {
            ...
            drawer.addConfig('search-result', drawerCfg);
            ...
            Context_17.registerService(CustomXTPointService_5.CustomXTPointService);
            dtoSvc.registerDataModel('[d.Structure][o.ExtensionPoint_Summary][workflowdata.CustomSvcRS]', CustomSvcRS_2.CustomSvcRS);
            var xp = Context_16.getService(ExtensionPointService_1.ExtensionPointService);
        ...
        Main.prototype.showHelperFlows = function () {
            ...
            rq.actionCode = "getFlows";
            new Promise(function (resolve) {
                var getFlows = Context_16.cf('NGV://REDAPP/SERVICE/COM.SABRE.TN.REDAPP.EXAMPLE.SHOWCASE.XTPOINTSERVICES.INTERFACES.ICUSTOMSVC:EXECUTE')
        ...
        Main.prototype.afterGetFlows = function (dta) {
            ...
            console.log(dta);
            Context_16.getService(LayerService_6.LayerService).showInModal(new HelperFlowsView_1.HelperFlowsView({ model: { flows: dta } }), mdlOptions, { display: 'areaView' });
        };
        Main.prototype.createPNR = function () {
            var pl = '<GetReservationRQ Version="1.19.0" xmlns="http://webservices.sabre.com/pnrbuilder/v1_19">' +
                '<RequestType>Stateful</RequestType><ReturnOptions>' +
                '<ViewName>Full</ViewName><ResponseFormat>STL</ResponseFormat>' +
                '</ReturnOptions></GetReservationRQ>';
            Context_16.getService(CustomXTPointService_5.CustomXTPointService).callSOAP(pl, "GetReservationRQ").
                then(function (res) {
                console.log("SOAP result");
                console.log(res);
                var dp = new DOMParser();
                var rsObj = JSON.parse(res);
                console.log("res.result");
                console.log(rsObj);
                console.log(rsObj.response.payload.responseText);
                var doc = dp.parseFromString(rsObj.response.payload.responseText, "text/xml");
                var nsResolver = doc.createNSResolver(doc.ownerDocument == null ? doc.documentElement : doc.ownerDocument.documentElement);
                //nsResolver.lookupNamespaceURI("");
                //(prefix) => {return nsResolver.lookupNamespaceURI(prefix) || nsResolver.lookupNamespaceURI("")}
                var resFunc = function (pf) {
                    var def = "";
                    var nsTab = {
                        "": "http://default",
                        "nst": "http://www.sabre.com",
                        "stl19": "http://webservices.sabre.com/pnrbuilder/v1_19",
                        "or114": "http://services.sabre.com/res/or/v1_14"
                    };
                    return nsTab[pf] || def;
                };
                var resParse = doc.evaluate("//stl19:OpenReservationElements/or114:OpenReservationElement/or114:ServiceRequest[@code = 'DOCS' or @code = 'DOCO' or @code = 'DOCA' or @code = 'PCTC' or @code = 'CTCE' or @code = 'CTCM' or @code = 'CTCR']//following-sibling::or114:NameAssociation/or114:NameRefNumber", doc.documentElement, resFunc, XPathResult.ANY_TYPE, null);
                console.log("res parse");
                var node = resParse.iterateNext();
                var arrExisting = new Array();
                var mpExisting = new Map();
                while (node) {
                    var txt = node.textContent;
                    console.log("key:" + txt);
                    if (!mpExisting.has(txt)) {
                        mpExisting.set(txt, 1);
                    }
                    node = resParse.iterateNext();
                }
                console.log(mpExisting);
                console.log(mpExisting.size);
            }).catch(function (res) {
                console.log("SOAP result");
                console.log(res);
            });
        ...
        Main.prototype.doQCCheck = function () {
            ...
            //let tenDaysAheadFlight = '1' + datesService.getNow().add(10, 'days').format('DDMMM').toUpperCase() + 'LGWKRK';
            Context_16.getService(CustomXTPointService_5.CustomXTPointService).fetchServiceData(new CustomSvcRQData_8.CustomSvcRQData(rq)).done(function (cfResponse) {
                console.log('aqui');
                console.log(cfResponse);
                console.log(cfResponse.rsPayload);
                console.log(cfResponse.getActionCode());
                ...
                console.log(rsDta);
                //console.log(cfResponse.getDataStructs());
                Context_16.getService(LayerService_6.LayerService).showInModal(new QCCheckView_2.QCCheckView({
                    model: { flows: rsDta }
                }), qcOptions, { display: 'areaView' });
            });
            /*
             cf('NGV://REDAPP/SERVICE/COM.SABRE.TN.REDAPP.EXAMPLE.SHOWCASE.XTPOINTSERVICES.INTERFACES.ICUSTOMSVC:EXECUTE')
             .setLocalPreference('silentRequest', true)
        ...
        Main.prototype.doFileFinish = function () {
            ...
            Context_16.cf('NGV://REDAPP/SERVICE/COM.SABRE.TN.REDAPP.EXAMPLE.SHOWCASE.XTPOINTSERVICES.INTERFACES.ICUSTOMSVC:EXECUTE')
                .setLocalPreference('silentRequest', true)
                .addRequestDataObject(new CustomSvcRQData_8.CustomSvcRQData(rq))
                .send();
        };
...
///<amd-module name="com-sabre-tn-redapp-example-showcase-mod" />
define("com-sabre-tn-redapp-example-showcase-mod", ["require", "exports", "com-sabre-tn-redapp-example-showcase-mod/Main", "com-sabre-tn-redapp-example-showcase-mod/Context"], function (require, exports, Main_1, Context_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Module_com_sabre_tn_redapp_example_showcase_mod = /** @class */ (function (_super) {
        __extends(Module_com_sabre_tn_redapp_example_showcase_mod, _super);
        function Module_com_sabre_tn_redapp_example_showcase_mod(manifest) {
            var _this = _super.call(this, manifest) || this;
            Context_18.context.setModule(_this);
            return _this;
        }
        return Module_com_sabre_tn_redapp_example_showcase_mod;
    }(Main_1.Main));
    exports.default = Module_com_sabre_tn_redapp_example_showcase_mod;
});
