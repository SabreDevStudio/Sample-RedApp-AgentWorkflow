...
@XmlRootElement(name = "RSResultSet", namespace = "http://example.redapp.tn.sabre.com/workflow/xtpointservices")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "RSResultSet", namespace = "http://example.redapp.tn.sabre.com/workflow/xtpointservices", propOrder = {
		"sampleResult" })
